...
if __name__ == "__main__":
    ...
    for i in range(1, 105):
        with open(f"../data/ins/HY-QS-{i}-combined.csv", "r") as f:
        ...
        for no, data in enumerate(data_list):
            print(f'Processing file {i}, {no + 1}/{N}')
        ...
        with open(f"../data/ins/combined_data{i}.csv.pickle", "wb") as f:
            pickle.dump(dataset, f)
        print(f'Processing for file {i} has finished!')

    print('The preprocess of all datasets has finished!')