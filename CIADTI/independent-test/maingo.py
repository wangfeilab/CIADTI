...
if __name__ == "__main__":
    ...
    parser.add_argument('--n_heads', type=int, default=8, help='th   e head count of self-attention')
    ...
    with open('../data/11.pickle',"rb") as f:
        datacase = pickle.load(f)
    ...
    for fold, (train_idx, val_idx) in enumerate(skf.split(data_train, labels)):
        ...
        for epoch in range(1, args.iteration+1):
            ...
            AUC_dev, PRC_dev, PRE_dev, REC_dev, t, y, s, trace1 = tester.test(dataset_dev)
            ...
            if AUC_dev > max_AUC_dev:
                ...
                test_auc, test_prc, test_pre, test_recall,T, Y, S, trace = tester.test(data_test)
                test_auc1, test_prc1, test_pre1, test_recall1,T1, Y1, S1, trace1 = tester.test(datacase)

                with open('TYShhhh.txt', 'a') as file:
                    file.write(f'{T1}, {Y1}, {S1},{trace}\n')
