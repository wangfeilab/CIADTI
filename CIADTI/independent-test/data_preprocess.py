...
if __name__ == "__main__":
    ...
    with open(output_file11, mode='w', newline='') as csvfile:
    ...
    print(f"成功将数据保存到 {output_file11}")
    compounds, adjacencies,proteins,interactions,smi_ids,prot_ids,Trace = [], [], [], [], [], [],[]
    ...
    with open(f"../data/P31644.pickle", "wb") as f:
